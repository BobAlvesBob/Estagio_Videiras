...
Os resultados são bastante positivos para um primeiro modelo de validação.
A precisão de 76,7\% indica poucos falsos positivos, enquanto o recall de
61,9\% sugere que ainda existe uma fração de objetos não detetados —
esperado dada a complexidade visual das imagens de vinha. A inferência
visual sobre imagens do conjunto de teste revelou que o modelo identifica
corretamente os \textbf{sarmentos} com elevada confiança (até 97\%) e o
\textbf{tronco} com boa confiança (83\%).
